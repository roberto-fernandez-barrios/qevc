...
population confidence intervals. Five deployments per budget suffice for the
scoped descriptive C3; no additional seeds are required for that claim.
...
supports audit development; both \texttt{final\_eval} roles remain unread.
...
mitigation is applied. Each realization refits the SVC and repeats Platt
...
error mitigation. Median transpiled depth and two-qubit count were 182 and 54;
